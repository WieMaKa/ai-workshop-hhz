...
- https://node-red-hhz-demo.eu-gb.cf.appdomain.cloud/ui/tone-analyzer
- https://node-red-hhz-demo.eu-gb.cf.appdomain.cloud/ui/translator
...
##### Step 3.2 - Translator
This example makes use of the [Watson Language Translator](https://www.ibm.com/watson/services/language-translator/) service. 

- Create an instance at https://cloud.ibm.com/
![](./screenshots/16.png)
![](./screenshots/16b.png)
- Access the manage (or service credentials) section and copy the `apikey` and `url` properties
![](./screenshots/17.png)
